...
//! An mpsc channel with conflict key message.

// /// single key mpsc channel
// pub mod kv_mpsc;
// /// multi key mpsc channel
// pub mod kv_mpsc_multik;

///. send data with priority, async receive
pub mod priotity_async_mpsc_chan;
mod tokio_transplant;